...
all: zerotier-1.10.6.tar.gz compile install
	@echo compiled zerotier
	@echo zerotier builddir: $(BUILD)/

zerotier-1.10.6.tar.gz:
	mkdir -p $(BUILD)/ $(BUILD)/src
	curl -L https://github.com/zerotier/ZeroTierOne/archive/1.10.6.tar.gz --output $(BUILD)/zerotier-1.10.6.tar.gz
