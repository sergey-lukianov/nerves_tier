...
all: zerotier-1.12.2.tar.gz compile install
	@echo compiled zerotier
	@echo zerotier builddir: $(BUILD)/

zerotier-1.12.2.tar.gz:
	mkdir -p $(BUILD)/ $(BUILD)/src
	curl -L https://github.com/zerotier/ZeroTierOne/archive/refs/tags/1.12.2.tar.gz --output $(BUILD)/zerotier-1.12.2.tar.gz
